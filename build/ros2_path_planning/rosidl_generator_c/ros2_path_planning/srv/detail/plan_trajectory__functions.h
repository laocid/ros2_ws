...
#ifndef ROS2_PATH_PLANNING__SRV__DETAIL__PLAN_TRAJECTORY__FUNCTIONS_H_
#define ROS2_PATH_PLANNING__SRV__DETAIL__PLAN_TRAJECTORY__FUNCTIONS_H_
...
#include "ros2_path_planning/msg/rosidl_generator_c__visibility_control.h"

#include "ros2_path_planning/srv/detail/plan_trajectory__struct.h"

/// Initialize srv/PlanTrajectory message.
/**
...
/// Create srv/PlanTrajectory message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2_path_planning__srv__PlanTrajectory_Request__init().
...
/// Destroy srv/PlanTrajectory message.
/**
 * It calls
 * ros2_path_planning__srv__PlanTrajectory_Request__fini()
...
/// Check for srv/PlanTrajectory message equality.
/**
...
/// Copy a srv/PlanTrajectory message.
/**
...
/// Initialize array of srv/PlanTrajectory messages.
/**
...
/// Finalize array of srv/PlanTrajectory messages.
/**
 * It calls
 * ros2_path_planning__srv__PlanTrajectory_Request__fini()
...
/// Create array of srv/PlanTrajectory messages.
/**
 * It allocates the memory for the array and calls
 * ros2_path_planning__srv__PlanTrajectory_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PlanTrajectory messages.
/**
 * It calls
 * ros2_path_planning__srv__PlanTrajectory_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PlanTrajectory message array equality.
/**
...
/// Copy an array of srv/PlanTrajectory messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2_path_planning__srv__PlanTrajectory_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_path_planning
...
/**
 * It calls
 * ros2_path_planning__srv__PlanTrajectory_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_path_planning
...
/**
 * It allocates the memory for the array and calls
 * ros2_path_planning__srv__PlanTrajectory_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_path_planning
...
/**
 * It calls
 * ros2_path_planning__srv__PlanTrajectory_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROS2_PATH_PLANNING__SRV__DETAIL__PLAN_TRAJECTORY__FUNCTIONS_H_
